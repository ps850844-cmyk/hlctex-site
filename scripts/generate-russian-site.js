...
const catalogMeta = {
  ...
  'textile/knitted-fabric': ['Производитель стандартного трикотажа | HLC', 'Стандартные трикотажные полотна HLC: кулирная гладь, рибана, интерлок и пике с подбором состава, плотности, цвета, грифа и отделки.']
};
...
const headingMap = {
  ...
  'textile/knitted-fabric': 'Стандартные трикотажные полотна'
};
...
const phrases = [
  ...
  ['Functional Knit Fabrics', 'Функциональные трикотажные ткани'], ['Wool Fabrics', 'Шерстяные ткани'], ['Sand-Washed Knit Fabrics', 'Трикотаж с песочной стиркой'], ['Knitted Fabrics', 'Стандартные трикотажные полотна'],
...
const editorial = {
  ...
  'textile/knitted-fabric': `<section aria-labelledby="bambooBenefitsTitle" class="bamboo-filter-editorial"><h2>Стандартный трикотаж для повседневной одежды</h2><p>HLC разрабатывает кулирную гладь, рибану, интерлок и пике для футболок, белья, детской одежды, пижам, поло и повседневных изделий. Доступны хлопок, вискоза, модал, вискоза из бамбука, шерсть, лён и смеси с синтетическими волокнами.</p></section>`
};

...
const catalogs = {
  ...
  'textile/knitted-fabric': ['定番ニット生地メーカー・サプライヤー｜HLC', '天竺、リブ、インターロック、鹿の子などの定番ニット生地を、混率、目付、色、風合い、後加工まで用途に合わせて開発します。']
};
...
const ui = [
  ...
  ['Sand-Washed Knit Fabrics','サンドウォッシュニット生地'], ['Knitted Fabrics','定番ニット生地'],
...
const editorial = {
  ...
  'textile/knitted-fabric': `<section aria-labelledby="bambooBenefitsTitle" class="bamboo-filter-editorial"><h2>デイリーウェア向け定番ニット生地</h2><p>HLC は T シャツ、肌着、子供服、パジャマ、ポロシャツ、カジュアルウェア向けに、天竺、リブ、インターロック、鹿の子を開発します。綿、レーヨン、モダール、竹由来レーヨン、ウール、リネン、合成繊維の混紡を、用途に合う目付、伸縮性、色、風合い、後加工で設計できます。</p></section>`
};
